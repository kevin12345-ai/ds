...
// 左电机 → 物理右电机 (TB6612 B通道 → MOTOR1)
// SysConfig: GPIO9 "RIGHT", PA16(IN1) + PB24(IN2)
#define LEFT_IN1_PORT  RIGHT_RIGHT_IN1_PORT // GPIOA
#define LEFT_IN1_PIN   RIGHT_RIGHT_IN1_PIN  // DL_GPIO_PIN_16 (PA16)
#define LEFT_IN2_PORT  RIGHT_RIGHT_IN2_PORT // GPIOB
#define LEFT_IN2_PIN   RIGHT_RIGHT_IN2_PIN  // DL_GPIO_PIN_24 (PB24)
#define LEFT_PWM_CH    GPIO_PWM_motor_C1_IDX

// 右电机 → 物理左电机 (TB6612 A通道 → MOTOR2)
// SysConfig: GPIO8 "LEFT", PB17(IN1) + PB19(IN2)
#define RIGHT_IN1_PORT  LEFT_PORT            // GPIOB
#define RIGHT_IN1_PIN   LEFT_LEFT_IN1_PIN    // DL_GPIO_PIN_17 (PB17)
#define RIGHT_IN2_PORT  LEFT_PORT            // GPIOB
#define RIGHT_IN2_PIN   LEFT_LEFT_IN2_PIN    // DL_GPIO_PIN_19 (PB19)
#define RIGHT_PWM_CH    GPIO_PWM_motor_C0_IDX
